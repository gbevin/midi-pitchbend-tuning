...
public class PitchBendTables {
    ...
    private static String pitchBendTableFor(long rangeCU) {
        var out = new StringBuilder("Pitch Offset in HCU,PB MIDI1,PB Hex MIDI2,Delta PB MIDI1,Pitch Offset from MIDI1,PB MIDI2,PB Hex MIDI2,Delta PB MIDI2,Pitch Offset from MIDI2\n");
        long last_pb1 = 0;
        long last_pb2 = 0;
